// Version 1.2
// Date: 2014-03-27 http://sh.codeplex.com Dedicated to Public Domain
...
namespace System.Data.SQLite
{
    ...
    public class SQLiteHelper
    {
        ...
        public bool TestConnection(string configDataSource)
        {
            try
            {
                using (SQLiteConnection conn = new SQLiteConnection(configDataSource))
                {
                    conn.Open();
                    conn.Close();
                }
