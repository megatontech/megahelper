...
namespace BaseUtils.DataBase
{
    public partial class SqliteHelper
    {
        ...
        private static SQLiteDataReader ExecuteDataReader(string connectionString, string commandText, params SQLiteParameter[] parms)
        {
            SQLiteConnection connection = new SQLiteConnection(connectionString);
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回只读数据集</returns>
        private static SQLiteDataReader ExecuteDataReader(string connectionString, CommandType commandType, string commandText, params SQLiteParameter[] parms)
        {
            SQLiteConnection connection = new SQLiteConnection(connectionString);
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回只读数据集</returns>
        private static SQLiteDataReader ExecuteDataReader(SQLiteConnection connection, CommandType commandType, string commandText, params SQLiteParameter[] parms)
        {
            return ExecuteDataReader(connection.ConnectionString, commandText, parms);
        }
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回只读数据集</returns>
        private static SQLiteDataReader ExecuteDataReader(SQLiteTransaction transaction, CommandType commandType, string commandText, params SQLiteParameter[] parms)
        {
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回只读数据集</returns>
        private static SQLiteDataReader ExecuteDataReader(SQLiteConnection connection, SQLiteTransaction transaction, CommandType commandType, string commandText, params SQLiteParameter[] parms)
        {
            SQLiteCommand command = new SQLiteCommand();
            PrepareCommand(command, connection, transaction, commandText, parms);
