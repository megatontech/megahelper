...
namespace BaseUtils
{
    public class DownloadHelper
    {
        ...
        #region 服务端下载 HTTP Server Download File
        ...
        #endregion 服务端下载 HTTP Server Download File

        #region 客户端下载 Client Download File
        ...
        /// <param name="nowyymm">年月</param>
        /// <param name="nowdd">日</param>
        public bool SaveUrlPics(string[] strIMGPath, string path)
        {
            string nowym = DateTime.Now.ToString("yyyy-MM");  //当前年月
            string nowdd = DateTime.Now.ToString("dd");       //当天号数
            path = path + nowym + "/" + nowdd;
        ...
        #endregion 客户端下载 Client Download File
    }
}